...
batch_siz=4
# 한번에 생성하는 양(미니 배치)
generator=ImageDataGenerator(rotation_range=20.0,width_shitf_range=0.2,height_shift_range=0.2,horizontal_flip=True)
...
for a in range(3):
  ...
  plt.shptitle("Generatior trial"+str(a+1))
